...
class PaymentController extends Controller
{
    ...
    public function sendMails($po, $be, $bex)
    {
        ...
        if ($bex->recurring_billing == 1) {
            ...
            PDF::loadView('pdf.subscription', $data)->save('assets/frontend/invoices/' . $fileName);
        ...
        if ($bex->recurring_billing == 1) {
            @unlink('assets/frontend/invoices/' . $fileName);
        }
    }
}
