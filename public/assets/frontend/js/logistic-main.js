(function ($) {
    ...
    $(window).on('scroll', function () {
      ...
      if (scroll < 100) {
        $(".logistics_header").removeClass("sticky");
      } else {
        $(".logistics_header").addClass("sticky");
      }
    });
    /*---------------------------------  
        sticky header JS
   ...
   -----------------------------------*/
    ...
    $('.feature_v1').on('mouseover', '.grid_item', function () {
      $('.grid_item.active_item').removeClass('active_item');
    ...
    if ($("#particles-js").length > 0) {
      particlesJS.load('particles-js', 'assets/frontend/js/particles.json');
    }
    /*---------------------- 
        Hero Area Particles Effect js
    ------------------------*/
