...
@section('styles')
<link rel="stylesheet" href="{{asset(' assets/fronend/css/jquery-ui.min.css')}}">
@endsection
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                @if($cart != null)
                    <ul class="total-item-info">
                        ...
                        <li><strong>{{__('Cart Total')}} :</strong>  <strong class="cart-total-view">  {{$cartTotal}}  </strong></li>
                    </ul>
                @endif
